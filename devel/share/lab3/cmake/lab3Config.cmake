...
if("TRUE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/alexanderrenken/Fanboat/src/lab3)
  set(lab3_DEVEL_PREFIX /home/alexanderrenken/Fanboat/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/alexanderrenken/Fanboat/install)
...
if(NOT "/home/alexanderrenken/Fanboat/devel/include " STREQUAL " ")
  set(lab3_INCLUDE_DIRS "")
  set(_include_dirs "/home/alexanderrenken/Fanboat/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'kaitlyn <kaitlynannbrady@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/alexanderrenken/Fanboat/src/lab3/${idir}'.  Ask the maintainer 'kaitlyn <kaitlynannbrady@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/alexanderrenken/Fanboat/devel/lib;/home/alexanderrenken/Fanboat/devel/lib;/opt/ros/indigo/lib)
