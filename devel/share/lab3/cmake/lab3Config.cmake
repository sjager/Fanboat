...
if("TRUE" STREQUAL "TRUE")
  set(lab3_SOURCE_PREFIX /home/jimmy/Fanboat/src/lab3)
  set(lab3_DEVEL_PREFIX /home/jimmy/Fanboat/devel)
  set(lab3_INSTALL_PREFIX "")
  set(lab3_PREFIX ${lab3_DEVEL_PREFIX})
else()
  set(lab3_SOURCE_PREFIX "")
  set(lab3_DEVEL_PREFIX "")
  set(lab3_INSTALL_PREFIX /home/jimmy/Fanboat/install)
...
if(NOT "/home/jimmy/Fanboat/devel/include " STREQUAL " ")
  set(lab3_INCLUDE_DIRS "")
  set(_include_dirs "/home/jimmy/Fanboat/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'lab3' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/jimmy/Fanboat/src/lab3/${idir}'.  Ask the maintainer 'kaitlyn <kaitlynannbrady@gmail.com>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/jimmy/Fanboat/devel/lib;/home/jimmy/Fanboat/devel/lib;/opt/ros/indigo/lib)
