...
;//! \htmlinclude magnitude.msg.html

(cl:defclass <magnitude> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defmethod cl:initialize-instance :after ((m <magnitude>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'magnitude)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name lab2-msg:<magnitude> is deprecated: use lab2-msg:magnitude instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <magnitude>))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<magnitude>)))
  "Returns string type for a message object of type '<magnitude>"
  "lab2/magnitude")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'magnitude)))
  "Returns string type for a message object of type 'magnitude"
  "lab2/magnitude")
